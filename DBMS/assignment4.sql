...
INSERT INTO Library_Notes (member_id, book_id, note_type, description, fine_amount, entry_date) VALUES
(1, 101, 'fine', 'Late return fine', 50.00, '2026-04-05'),
(1, 101, 'fine', 'Late return fine', 50.00, '2026-04-05'),
(2, 102, 'remark', 'Book slightly damaged', NULL, '2026-04-04'),
(3, 103, 'late', 'Submitted 3 days late', 30.00, '2026-04-10'),
(4, NULL, 'donation', 'Donated 2 fiction books', NULL, '2026-03-15'),
(5, 105, 'remark', 'Good borrower', NULL, '2026-04-06');

commit;

ALTER TABLE Library_Notes RENAME TO Library_Remarks; 

commit;

DROP TABLE Library_Remarks;
